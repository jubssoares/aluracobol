       ...
       PROGRAM-ID. CALCULARAUMENTOSALARIAL.
      ******************************************************
      ***   AREA DE COMENTARIOS - REMARKS
      ***   OBJETIVO: PROGRAMA QUE CALCULA AUMENTO SALARIAL
      ...
      ******************************************************
       ...
       EVALUATE WRK-TEMPOCASA
        WHEN 0 THRU 1 COMPUTE WRK-AUMENTO = 0
        WHEN 2 THRU 5 COMPUTE WRK-AUMENTO = WRK-SALARIO * 0,05
        WHEN 6 THRU 15 COMPUTE WRK-AUMENTO = WRK-SALARIO * 0,10
        WHEN OTHER COMPUTE WRK-AUMENTO = WRK-SALARIO * 0,15
       END-EVALUATE.
